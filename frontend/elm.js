...
var _user$project$Home$page = {
	...
	content: A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('this is the homepage')
			]))
};

var _user$project$Routing$bla = '';

var _user$project$UserProfile$white = _debois$elm_mdl$Material_Color$text(_debois$elm_mdl$Material_Color$white);
var _user$project$UserProfile$page = {
	title: 'Profile Page',
	needsUser: true,
	content: A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[_user$project$UserProfile$white]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(' clicks so far.')
					])),
				A2(
				_debois$elm_mdl$Material_Card$actions,
				_elm_lang$core$Native_List.fromArray(
					[_debois$elm_mdl$Material_Card$border, _user$project$UserProfile$white]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Main$renderTabLink = function (page) {
	return A2(
		_elm_lang$html$Html$a,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$Main$renderTabs = function (pages) {
	return A2(_elm_lang$core$List$map, _user$project$Main$renderTabLink, pages);
};
var _user$project$Main$indicesOf = F2(
...
var _user$project$Main$firstIndexOf = F2(
	function (thing, things) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			-1,
			_elm_lang$core$List$minimum(
				A2(_user$project$Main$indicesOf, thing, things)));
	});
var _user$project$Main$registerPage = F2(
	function (pageType, rawPage) {
		var _p2 = pageType;
		return {pageType: pageType, title: rawPage.title, needsUser: rawPage.needsUser, content: rawPage.content};
	});
var _user$project$Main$dummyUser = {email: 'Simon.Gausmann@Gausmann-Media.de'};
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {mdl: a, currentUser: b, currentPage: c};
	});
...
var _user$project$Main$Page = F4(
	function (a, b, c, d) {
		return {pageType: a, title: b, needsUser: c, content: d};
	});
var _user$project$Main$PageRaw = F3(
	function (a, b, c) {
		return {title: a, needsUser: b, content: c};
	});
var _user$project$Main$ErrorPageType = {ctor: 'ErrorPageType'};
var _user$project$Main$ProfilePageTyp = {ctor: 'ProfilePageTyp'};
var _user$project$Main$AboutPageTyp = {ctor: 'AboutPageTyp'};
var _user$project$Main$HomePageTyp = {ctor: 'HomePageTyp'};
var _user$project$Main$allPages = _elm_lang$core$Native_List.fromArray(
	[
		A2(_user$project$Main$registerPage, _user$project$Main$HomePageTyp, _user$project$Home$page),
		A2(_user$project$Main$registerPage, _user$project$Main$ProfilePageTyp, _user$project$UserProfile$page),
		{
		pageType: _user$project$Main$AboutPageTyp,
		title: 'About',
		needsUser: true,
		content: A2(
			_elm_lang$html$Html$div,
		...
		{
		pageType: _user$project$Main$ErrorPageType,
		title: '404',
		needsUser: false,
		content: A2(
			_elm_lang$html$Html$div,
...
var _user$project$Main$getPage = F2(
		...
		while (true) {
			var _p3 = _elm_lang$core$List$head(
				A2(
					_elm_lang$core$List$filter,
					function (page) {
						return _elm_lang$core$Native_Utils.eq(page.pageType, pageType);
					},
					pages));
			if (_p3.ctor === 'Nothing') {
				var _v3 = _user$project$Main$ErrorPageType,
					_v4 = _user$project$Main$allPages;
				pageType = _v3;
				pages = _v4;
				continue getPage;
			} else {
...
var _user$project$Main$init = {
	currentPage: A2(_user$project$Main$getPage, _user$project$Main$HomePageTyp, _user$project$Main$allPages),
	currentUser: _elm_lang$core$Maybe$Nothing,
	mdl: _debois$elm_mdl$Material$model
};
var _user$project$Main$getPageByTabIndex = F2(
	function (num, pages) {
		var _p4 = A2(
			_elm_lang$core$Array$get,
			num,
			_elm_lang$core$Array$fromList(pages));
		if (_p4.ctor === 'Nothing') {
			return A2(_user$project$Main$getPage, _user$project$Main$ErrorPageType, _user$project$Main$allPages);
		} else {
			return _p4._0;
		}
	});
var _user$project$Main$getPagesForUser = function (user) {
	var _p5 = user;
	if (_p5.ctor === 'Nothing') {
		return A2(
			_elm_lang$core$List$filter,
			function (page) {
				return _elm_lang$core$Native_Utils.eq(page.needsUser, false) && (!_elm_lang$core$Native_Utils.eq(page.pageType, _user$project$Main$ErrorPageType));
			},
			_user$project$Main$allPages);
	} else {
		return A2(
			_elm_lang$core$List$filter,
			function (page) {
				return !_elm_lang$core$Native_Utils.eq(page.pageType, _user$project$Main$ErrorPageType);
			},
			_user$project$Main$allPages);
	}
};
	...
	function (msg, model) {
		...
		switch (_p6.ctor) {
			case 'NavigationAction':
				var currentPage = A2(
					_user$project$Main$getPage,
					_p6._0,
					_user$project$Main$getPagesForUser(model.currentUser));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'Login':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							currentUser: _elm_lang$core$Maybe$Just(_p6._0),
							currentPage: currentPage
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Logout':
				var currentPage = A2(_user$project$Main$getPage, _user$project$Main$HomePageTyp, _user$project$Main$allPages);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{currentUser: _elm_lang$core$Maybe$Nothing, currentPage: currentPage}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Mdl':
			...
			default:
				var currentPage = A2(
					_user$project$Main$getPageByTabIndex,
					_p6._0,
					_user$project$Main$getPagesForUser(model.currentUser));
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$NavigationAction = function (a) {
	return {ctor: 'NavigationAction', _0: a};
};
var _user$project$Main$renderUserMenu = function (user) {
	var _p7 = user;
	if (_p7.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$div,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Events$onClick(
							_user$project$Main$Login(_user$project$Main$dummyUser))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Events$onClick(
							_user$project$Main$NavigationAction(_user$project$Main$ProfilePageTyp))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('my Profile')
						]))
				]));
	}
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Main$renderUserMenu(model.currentUser)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Main$renderPage(model.currentPage)
					]))
			]));
};
		...
		A4(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						_user$project$Main$firstIndexOf,
						model.currentPage,
						_user$project$Main$getPagesForUser(model.currentUser))),
				...
				]),
			{
				...
				tabs: {
					ctor: '_Tuple2',
					_0: _user$project$Main$renderTabs(
						_user$project$Main$getPagesForUser(model.currentUser)),
					_1: _elm_lang$core$Native_List.fromArray(
						[])
				},
